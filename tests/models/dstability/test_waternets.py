...
class TestDStabilityHeadLine:
    ...
    def test_edit_head_line(self):
        ...
        head_line_2 = dsm.datastructure.waternets[0].get_head_line(str(headline_id_2))
...
class TestDStabilityReferenceLine:
    ...
    def test_edit_reference_line(self):
        ...
        dsm.edit_reference_line(reference_line_id=reference_line_id_2, points=points_v2,
