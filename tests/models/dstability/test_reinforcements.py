...
from geolib.models.dstability.internal import PersistableForbiddenLine, PersistableGeotextile, PersistableNail
from geolib.models.dstability.reinforcements import (DStabilityReinforcement,
                                                     ForbiddenLine, Geotextile,
                                                     Nail)
...
def _get_geotextile() -> Geotextile:
    ...
    return Geotextile(start=start, end=end, effective_tensile_strength=5, reduction_area=5)
...
class TestGeotextile:
    ...
    def test_initialized_with_negative_tensile_strength(self, _get_geotextile):
        ...
        with pytest.raises(ValidationError):
            Geotextile(start=start, end=end, effective_tensile_strength=-5, reduction_area=5)
    ...
    def test_add_reinforcement_geotextile(self, _get_geotextile):
        ...
        assert dstability_datastructure.TensileStrength == geotextile.effective_tensile_strength
