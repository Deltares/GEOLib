...
class TestDStabilityAnalysis:
    ...
    def test_create_bishop_analysis(self):
        ...
        assert dstability_model.datastructure.calculationsettings[0].Bishop == bishop_analysis._to_internal_datastructure()
    ...
    def test_create_bishop_brute_force_analysis(self):
        ...
        assert dstability_model.datastructure.calculationsettings[0].BishopBruteForce == bishop_brute_force_analysis._to_internal_datastructure()
    ...
    def test_create_spencer_analysis(self):
        ...
        assert dstability_model.datastructure.calculationsettings[0].Spencer == spencer_analysis._to_internal_datastructure()
    ...
    def test_create_spencer_genetic_algorithm_analysis(self):
        ...
        assert dstability_model.datastructure.calculationsettings[0].SpencerGenetic == spencer_genetic_algorithm_analysis._to_internal_datastructure()
    ...
    def test_create_uplift_van_algorithm_analysis(self):
        ...
        assert dstability_model.datastructure.calculationsettings[0].UpliftVan == uplift_van_analysis._to_internal_datastructure()
    ...
    def test_create_uplift_van_particle_swarm_algorithm_analysis(self):
        ...
        uplift_van_particle_swarm_analysis = DStabilityUpliftVanParticleSwarmAnalysisMethod(
            search_area_a=DStabilitySearchArea(height=5.0, top_left=Point(x=-10., z=10.0), width=5.0),
            search_area_b=DStabilitySearchArea(height=5.0, top_left=Point(x=10., z=10.0), width=5.0),
            tangent_area_height=2.0,
            tangent_area_top_z=-5.0
        )
        dstability_model.set_model(uplift_van_particle_swarm_analysis)
        assert dstability_model.datastructure.calculationsettings[0].UpliftVanParticleSwarm == uplift_van_particle_swarm_analysis._to_internal_datastructure()
    ...
    def test_parse_spencer_genetic_settings(self, dir_path: str):
        ...
        assert dstability_model.datastructure.calculationsettings[0].SpencerGenetic == spencer_genetic_analysis._to_internal_datastructure()
    ...
    def test_parse_upliftvan_settings(self, dir_path: str):
        ...
        uplift_van_analysis = DStabilityUpliftVanAnalysisMethod(
            first_circle=DStabilityCircle(center=Point(x=6.73, z=17.54), radius=13.599830881301427),
